/* eslint-disable */
export const DICE = {
	// Dés de base (requis pour la géométrie)
	d4: {
	...
	// ============ LOVE TOGETHER - Dés personnalisés ============
	...
	dbody: {
		name: 'Dé Corps',
		type: 'd6',
		labels: ['Head', 'Tits', 'Belly', 'Ass', 'Feet', 'Hair'],
		values: [1, 6],
		scale: 0.9,
		display: 'labels',
		system: 'love',
	...
	// Dé des actions (texte)
	daction: {
		name: 'Dé Action',
		type: 'd6',
		labels: ['Kiss', 'Massage', 'Touch', 'Lick', 'Bite', 'Blow'],
		values: [1, 6],
		scale: 0.9,
		display: 'labels',
		system: 'love',
	...
	dduration: {
		name: 'Dé Durée',
		type: 'd6',
		labels: ['10s', '30s', '1min', '2min', '3min', '5min'],
		values: [1, 6],
		scale: 0.9,
		display: 'labels',
		system: 'love',
